// @routes-hash 8d0bd75a9e06280f64490cd32d7a5b2e
...
import route59 from "./routes/production/storyboard/generatestory2Image";
import route60 from "./routes/production/storyboard/getStoryboardData";
import route61 from "./routes/production/storyboard/pollingImage";
import route62 from "./routes/production/storyboard/previewImage";
import route63 from "./routes/production/workbench/confirmSelection";
import route64 from "./routes/production/workbench/delVideo";
import route65 from "./routes/production/workbench/generateVideo";
import route66 from "./routes/production/workbench/generateVideoPrompt";
import route67 from "./routes/production/workbench/getChatLines";
import route68 from "./routes/production/workbench/getVideoModelDetail";
import route69 from "./routes/production/workbench/videoPolling";
import route70 from "./routes/project/addProject";
import route71 from "./routes/project/addVisual";
import route72 from "./routes/project/addVisualManual";
import route73 from "./routes/project/deleteVisualManual";
import route74 from "./routes/project/delProject";
import route75 from "./routes/project/editProject";
import route76 from "./routes/project/editVisualManual";
import route77 from "./routes/project/getProject";
import route78 from "./routes/project/getVisualManual";
import route79 from "./routes/project/visualManual";
import route80 from "./routes/script/addScript";
import route81 from "./routes/script/delScript";
import route82 from "./routes/script/exportScript";
import route83 from "./routes/script/extractAssets";
import route84 from "./routes/script/getScrptApi";
import route85 from "./routes/script/pollScriptAssets";
import route86 from "./routes/script/updateScript";
import route87 from "./routes/scriptAgent/getPlanData";
import route88 from "./routes/scriptAgent/setPlanData";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/storyboard/generatestory2Image", route59);
  app.use("/api/production/storyboard/getStoryboardData", route60);
  app.use("/api/production/storyboard/pollingImage", route61);
  app.use("/api/production/storyboard/previewImage", route62);
  app.use("/api/production/workbench/confirmSelection", route63);
  app.use("/api/production/workbench/delVideo", route64);
  app.use("/api/production/workbench/generateVideo", route65);
  app.use("/api/production/workbench/generateVideoPrompt", route66);
  app.use("/api/production/workbench/getChatLines", route67);
  app.use("/api/production/workbench/getVideoModelDetail", route68);
  app.use("/api/production/workbench/videoPolling", route69);
  app.use("/api/project/addProject", route70);
  app.use("/api/project/addVisual", route71);
  app.use("/api/project/addVisualManual", route72);
  app.use("/api/project/deleteVisualManual", route73);
  app.use("/api/project/delProject", route74);
  app.use("/api/project/editProject", route75);
  app.use("/api/project/editVisualManual", route76);
  app.use("/api/project/getProject", route77);
  app.use("/api/project/getVisualManual", route78);
  app.use("/api/project/visualManual", route79);
  app.use("/api/script/addScript", route80);
  app.use("/api/script/delScript", route81);
  app.use("/api/script/exportScript", route82);
  app.use("/api/script/extractAssets", route83);
  app.use("/api/script/getScrptApi", route84);
  app.use("/api/script/pollScriptAssets", route85);
  app.use("/api/script/updateScript", route86);
  app.use("/api/scriptAgent/getPlanData", route87);
  app.use("/api/scriptAgent/setPlanData", route88);
